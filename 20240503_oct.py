...
from vortex.engine import EngineConfig, Engine, StackDeviceTensorEndpointInt8 as StackDeviceTensorEndpoint, AscanStreamEndpoint, CounterStreamEndpoint, GalvoTargetStreamEndpoint, GalvoActualStreamEndpoint, MarkerLogStorage, NullEndpoint, RadialDeviceTensorEndpointInt8 as RadialDeviceTensorEndpoint
...
class System(QWidget):
    ...
    def _setup_display(self):
        ...
        rfec.segment_rt_extent = (self._aiming_config.bscan_extent, self._aiming_config.volume_extent)
        rfec.radial_segments_per_volume = self._aiming_config.bscans_per_volume
        rfec.radial_records_per_segment = self._aiming_config.ascans_per_bscan

        rfe = RadialFormatExecutor()
        rfe.initialize(rfec)
        radial_tensor_endpoint = RadialDeviceTensorEndpoint(rfe, (self._aiming_config.bscans_per_volume, self._aiming_config.ascans_per_bscan, samples_to_save), get_logger('radial', self._cfg.log_level))
        #########
        ...
        self._aiming_tensor_endpoint = radial_tensor_endpoint
