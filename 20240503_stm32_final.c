...
int NUM_OF_BYTES_PER_CHUNK_RASTER = 16384;
int NUM_OF_BYTES_PER_CHUNK_RADIAL = 16384;
//Write how many bytes user want inside a buffer (4 * NUM_OF_POSITIONS)
//uint8_t txData[32448];
//uint8_t rxData[32448];
uint8_t txData[40000];
uint8_t rxData[40000];
uint8_t StartByte;
...
void HAL_SPI_RxCpltCallback (SPI_HandleTypeDef *hspi){
	if(rxData[2 * NUM_OF_BYTES_PER_CHUNK] == 3){
		 state = 3;
		 LED_Toggle();
	}
}
